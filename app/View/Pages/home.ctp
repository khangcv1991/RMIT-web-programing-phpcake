...
<?php echo $this->Html->css('homecss'); 
echo $this->Html->script('homeJS');
?>
					...
					<div class="mtabs-content">
								...
								<ul class="items">
									<li class="theme">
										<div class="item-wrapper" style="">
											<a href=""> <img alt="Ant Man" src="<?php echo $this->webroot; ?>img/ant-man.png"
												height="280px" width="168px" class="movie-image" /> <img
												alt="" src="<?php echo $this->webroot; ?>img/PG.png"
									...
									<li class="theme">
										<div class="item-wrapper" style="">
											<a href=""> <img alt="Force of Destiny"
												src="<?php echo $this->webroot; ?>img/forceofdestiny.png" height="280px" width="168px"
												class="movie-image" /> <img alt="" src="<?php echo $this->webroot; ?>img/CTC.png"
									...
									<li class="theme">
										<div class="item-wrapper" style="">
											<a href=""> <img alt="Ben-Hur" src="<?php echo $this->webroot; ?>img/ben-hur.png"
												height="280px" width="168px" class="movie-image" /> <img
												alt="" src="<?php echo $this->webroot; ?>img/PG.png"
												style="position: absolute; padding-left: 141px; padding-top: 5px;" />
											</a>
									...
									<li class="theme">
										<div class="item-wrapper" style="">
											<a href=""> <img alt="A Walk in the Woods"
												src="<?php echo $this->webroot; ?>img/a-walk-in-the-woods.png" height="280px"
												width="168px" class="movie-image" /> <img alt=""
												src="<?php echo $this->webroot; ?>img/M.png"
												style="position: absolute; padding-left: 141px; padding-top: 5px;" />
											</a>
									...
									<li class="theme">
										<div class="item-wrapper" style="">
											<a href=""> <img alt="Straight Outta Compton"
												src="<?php echo $this->webroot; ?>img/straight-outta-compton.png" height="280px"
												width="168px" class="movie-image" /> <img alt=""
												src="<?php echo $this->webroot; ?>img/MA15+.png"
												style="position: absolute; padding-left: 141px; padding-top: 5px; height: 25px; width: 25px" />
											</a>
						...
						<div id="tab-2" style="display: block;">
							<ul class="items">
								<li class="theme">
									<div class="item-wrapper" style="">
										<a href=""> <img alt="" src="<?php echo $this->webroot; ?>img/life.png" height="280px"
											width="168px" class="movie-image" /> <img alt=""
											src="<?php echo $this->webroot; ?>img/MA15+.png"
											style="position: absolute; padding-left: 141px; padding-top: 5px; height: 25px; width: 25px" />
										</a>
								...
								<li class="theme">
									<div class="item-wrapper" style="">
										<a href=""> <img alt="" src="<?php echo $this->webroot; ?>img/the-scorch-trials.png"
											height="280px" width="168px" class="movie-image" /> <img
											alt="" src="<?php echo $this->webroot; ?>img/M.png"
											style="position: absolute; padding-left: 141px; padding-top: 5px;" />
										</a>
								...
								<li class="theme">
									<div class="item-wrapper" style="">
										<a href=""> <img alt="" src="<?php echo $this->webroot; ?>img/umrika.png" height="280px"
											width="168px" class="movie-image" /> <img alt=""
											src="<?php echo $this->webroot; ?>img/M.png"
											style="position: absolute; padding-left: 141px; padding-top: 5px;" />
										</a>
								...
								<li class="theme">
									<div class="item-wrapper" style="">
										<a href=""> <img alt="" src="<?php echo $this->webroot; ?>img/oddball.png" height="280px"
											width="168px" class="movie-image" /> <img alt=""
											src="<?php echo $this->webroot; ?>img/CTC.png"
											style="position: absolute; padding-left: 141px; padding-top: 5px; height: 25px; width: 25px" />
										</a>
								...
								<li class="theme">
									<div class="item-wrapper" style="">
										<a href=""> <img alt="" src="<?php echo $this->webroot; ?>img/the-evil-dead.png"
											height="280px" width="168px" class="movie-image" /> <img
											alt="" src="<?php echo $this->webroot; ?>img/18+.png"
											style="position: absolute; padding-left: 141px; padding-top: 5px; height: 25px; width: 25px" />
										</a>
